...
#et rotation. x = PC. Le 1er représente le plus de variation, 2e est le 2e. En vérifiant 
...
?svd
svd.prep <- svd(scale(t(données), center=TRUE))
svd.prep
svd.données <- data.frame(Sample=colnames(données),
